...
# ENV Variables to populate:
# export azure_terraform_prefix='env-name'
# export AZURE_ROOT_SERVICE_PRINCIPAL_CLIENT_SECRET='your service principal secret'
# export AZURE_NETWORK_SERVICE_PRINCIPAL_CLIENT_SECRET='your service principal secret'
# export AZURE_PCF_SERVICE_PRINCIPAL_CLIENT_SECRET='your service principal secret'
